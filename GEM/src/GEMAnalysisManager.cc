...
GEMAnalysisManager* GEMAnalysisManager::instance = 0;

GEMAnalysisManager::GEMAnalysisManager()
:analysisFactory(0), hFactory(0), tFactory(0), plotter(0)
{
  ...
  if(analysisFactory)
  {
    ...
    tree = treeFactory->create("GEM.aida","xml",false,true,"compress=yes");
...
IHistogramFactory* GEMAnalysisManager::getHistogramFactory()
{
  return hFactory;
}
ITupleFactory* GEMAnalysisManager::getTupleFactory()
{
  return tFactory;
}
IPlotter* GEMAnalysisManager::getPlotter()
{
  return plotter;
}

GEMAnalysisManager* GEMAnalysisManager::getInstance()
{
  if (instance == 0) instance = new GEMAnalysisManager();
  return instance;
}

void GEMAnalysisManager::dispose()
{
  if (instance != 0)
  {
    delete instance;
