...
// ********************************************************************
//
// $Id: GEMHadCalorimeter.cc,v 1.6 2006-06-29 16:32:43 gunter Exp $
// --------------------------------------------------------------
//
...
GEMHadCalorimeter::GEMHadCalorimeter(G4String name)
...
GEMHadCalorimeter::~GEMHadCalorimeter(){;}

void GEMHadCalorimeter::Initialize(G4HCofThisEvent*HCE)
{
  hitsCollection = new GEMHadCalorimeterHitsCollection
  ...
  {
    GEMHadCalorimeterHit* aHit = new GEMHadCalorimeterHit();
    hitsCollection->insert( aHit );
  }
}

G4bool GEMHadCalorimeter::ProcessHits(G4Step*aStep,G4TouchableHistory* /*ROhist*/)
{
  ...
  GEMHadCalorimeterHit* aHit = (*hitsCollection)[hitID];
...
void GEMHadCalorimeter::EndOfEvent(G4HCofThisEvent* /*HCE*/)
{;}
