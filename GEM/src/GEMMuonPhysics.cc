...
// ********************************************************************
//
// $Id: GEMMuonPhysics.cc,v 1.10 2009-12-02 22:45:09 perl Exp $
// --------------------------------------------------------------
//
...
GEMMuonPhysics::GEMMuonPhysics(const G4String& name)
                   :  G4VPhysicsConstructor(name)
{
}

GEMMuonPhysics::~GEMMuonPhysics()
{
}
...
void GEMMuonPhysics::ConstructProcess()
{
