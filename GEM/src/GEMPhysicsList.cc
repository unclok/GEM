...
// ********************************************************************
//
// $Id: GEMPhysicsList.cc,v 1.8 2006-06-29 16:33:03 gunter Exp $
// --------------------------------------------------------------
//
...
GEMPhysicsList::GEMPhysicsList():  G4VModularPhysicsList()
{
  ...
  G4cout << "You are using the GEMPhysicsList" << G4endl;
  ...
  G4cout << "GEMPhysicsList is optimized for robustness" << G4endl;
  ...
  G4cout << "please consider the usage of hadronic_lists instead of GEMPhysicsLists." << G4endl;
  ...
  RegisterPhysics(  new GEMHadronPhysics("hadron"));
// We do not use hadronic lists since v7.
  ...
  RegisterPhysics( new GEMIonPhysics("ion"));
