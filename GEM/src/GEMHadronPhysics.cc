...
// ********************************************************************
//
// $Id: GEMHadronPhysics.cc,v 1.9 2009-11-21 01:00:19 perl Exp $
// --------------------------------------------------------------
//
...
GEMHadronPhysics::GEMHadronPhysics(const G4String& name)
                   :  G4VPhysicsConstructor(name)
{
}

GEMHadronPhysics::~GEMHadronPhysics()
{
}
...
void GEMHadronPhysics::ConstructProcess()
{
