...
// ********************************************************************
//
// $Id: GEMHadCalorimeterHit.cc,v 1.11 2006-11-14 07:11:19 perl Exp $
// --------------------------------------------------------------
//
...
G4Allocator<GEMHadCalorimeterHit> GEMHadCalorimeterHitAllocator;

GEMHadCalorimeterHit::GEMHadCalorimeterHit()
{
  columnID = -1;
  rowID = -1;
  edep = 0.;
...
GEMHadCalorimeterHit::GEMHadCalorimeterHit(G4int iCol,G4int iRow)
{
  columnID = iCol;
  rowID = iRow;
  edep = 0.;
...
GEMHadCalorimeterHit::GEMHadCalorimeterHit(const GEMHadCalorimeterHit &right)
    : G4VHit() {
...
const GEMHadCalorimeterHit& GEMHadCalorimeterHit::operator=(const GEMHadCalorimeterHit &right)
{
  columnID = right.columnID;
  rowID = right.rowID;
  edep = right.edep;
...
int GEMHadCalorimeterHit::operator==(const GEMHadCalorimeterHit &right) const
{
  return (columnID==right.columnID&&rowID==right.rowID);
}

void GEMHadCalorimeterHit::Draw()
{
...
const std::map<G4String,G4AttDef>* GEMHadCalorimeterHit::GetAttDefs() const
{
  G4bool isNew;
  std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("GEMHadCalorimeterHit",isNew);
  if (isNew) {
...
std::vector<G4AttValue>* GEMHadCalorimeterHit::CreateAttValues() const
{
...
void GEMHadCalorimeterHit::Print()
{
