...
// ********************************************************************
//
// $Id: GEMIonPhysics.cc,v 1.10 2009-11-21 01:00:19 perl Exp $
// --------------------------------------------------------------
//
...
GEMIonPhysics::GEMIonPhysics(const G4String& name)
                 :  G4VPhysicsConstructor(name)
{
}

GEMIonPhysics::~GEMIonPhysics()
{
}
...
void GEMIonPhysics::ConstructProcess()
{
