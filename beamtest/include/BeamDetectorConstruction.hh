#ifndef BeamDetectorConstruction_h
#define BeamDetectorConstruction_h 1
...
class BeamDetectorConstruction : public G4VUserDetectorConstruction
{
public:
	BeamDetectorConstruction();
	virtual ~BeamDetectorConstruction();
