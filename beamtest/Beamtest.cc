...
int main(int argc, char** argv)
{
	...
	runManager->SetUserInitialization(new BeamDetectorConstruction);
	...
	runManager->SetUserAction(new BeamPrimaryGeneratorAction);

	// optianal user action classes
	runManager->SetUserAction(new BeamRunAction);
