...
G4double BeamRun::GetTotalSurfCurrent(G4int id)
{
	if(id==1){
		G4int key;
		G4int n=0;
...
G4double BeamRun::GetElectronSurfCurrent(G4int id)
{
	if(id==1){
		G4int key;
		G4int n=0;
...
G4double BeamRun::GetEnergyAverage(G4int id)
{
	if(id==1){
		G4int key;
		G4int n=0;
...
G4double BeamRun::GetSecondaryCurrent()
{
	G4int key;
	G4int n=0;
	G4double val=0;
