...
class A01DriftChamberHit : public G4VHit
{
  ...
  public:
      ...
      inline void SetParticleID(G4String pid) { fParticleID = pid; }
      inline G4String GetParticleID() const { return fParticleID; }
};
