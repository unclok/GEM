...
:fefield(100.),fefielddirection(0.,0.,1.)
{
	...
	pIntgrDriver = new G4MagInt_Driver(1.*mm,pStepper,pStepper->GetNumberOfVariables());
...
G4VPhysicalVolume* NewDetectorConstruction::Construct()
{
	...
	G4VSolid* worldSolid = new G4Box("worldBox",50.*mm,50.*mm,1000.*mm);
	...
	// GEM Mother volume
	G4VSolid* GEMSolid = new G4Box("GEMBox",50.*mm,50.*mm,1000.*mm);
	G4LogicalVolume* GEMLogical = new G4LogicalVolume(GEMSolid,galactic,"GEMLogical",0,0,0);

	new G4PVPlacement(0,G4ThreeVector(0.,0.,0.*mm),GEMLogical,"GEMPhysical",worldLogical,0,0);
	...
	argon_solid = new G4Box("argon_solid",50.*mm,50.*mm,60.2*mm);
	...
	argon_physical = new G4PVPlacement(0,G4ThreeVector(0.,0.,0.*mm),argon_logical,"argon_physical",GEMLogical,false,0);

	copper_box = new G4Box("copper_box",50.*mm,50.*mm,2.5*mm);
	copper_hole = new G4Tubs("copper_hole",0.*mm,35.*mm,2.5*mm,0.,360.*deg);
	copper_solid = new G4SubtractionSolid("copper_solid",copper_box,copper_hole,0,G4ThreeVector(0.,0.,0.*mm));
	//copper_solid = new G4Box("copper_solid",50.*mm,50.*mm,2.5*mm);
	copper_logical = new G4LogicalVolume(copper_solid,copper,"copper_logical",0,0,0);
	//copper1_physical = new G4PVPlacement(0,G4ThreeVector(0.,0.,-22.5*mm),copper_logical,"copper_physical",argon_logical,false,0);
	//copper2_physical = new G4PVPlacement(0,G4ThreeVector(0.,0.,22.5*mm),copper_logical,"copper_physical",argon_logical,false,0);
	...
	hit_solid = new G4Box("hit_counter",100.*mm,100.*mm,0.1*mm);
	hit_counter1 = new G4LogicalVolume(hit_solid,galactic,"hit_counter1",0,0,0);
	hc_physical1 = new G4PVPlacement(0,G4ThreeVector(0.,0.,-60.1*mm),hit_counter1,"dc1_physical",argon_logical,false,0);
	hit_counter2 = new G4LogicalVolume(hit_solid,galactic,"hit_counter2",0,0,0);
	hc_physical2 = new G4PVPlacement(0,G4ThreeVector(0.,0.,60.1*mm),hit_counter2,"dc2_physical",argon_logical,false,0);

	dc_logical1 = new G4LogicalVolume(hit_solid,galactic,"dc1",0,0,0);
	dc_physical1 = new G4PVPlacement(0,G4ThreeVector(0.,0.,-60.3*mm),dc_logical1,"dc1_physical",GEMLogical,false,0);
	dc_logical2 = new G4LogicalVolume(hit_solid,galactic,"dc2",0,0,0);
	dc_physical2 = new G4PVPlacement(0,G4ThreeVector(0.,0.,60.3*mm),dc_logical2,"dc2_physical",GEMLogical,false,0);
