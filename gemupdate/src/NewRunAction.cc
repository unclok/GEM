...
void NewRunAction::BeginOfRunAction(const G4Run* aRun)
{
	...
	analysisManager->CreateH2("h1","2D Energy deposit distribution at z=-4000um", 100, -4050*um, 4050*um, 100, -2500*um, 2500*um);
	analysisManager->CreateH2("h2","2D Energy deposit distribution at z=2000um", 100, -4050*um, 4050*um, 100, -2500*um, 2500*um);
	analysisManager->CreateH2("h3","2D position distribution at z=-4000um", 100, -4050*um, 4050*um, 100, -2500*um, 2500*um);
	analysisManager->CreateH2("h4","2D position distribution at z=2000um", 100, -4050*um, 4050*um, 100, -2500*um, 2500*um);
}
