...
void GEMElectricField::GetFieldValue(const G4double point[4],G4double *Bfield) const
{
...
//	G4cout << "----------------------GetFieldValue Working----------------------" << endl;
	...
	G4cout << "dy : " << dy << endl;
	G4cout << "dz : " << dz << endl;
	G4cout << "xlocal : " << xlocal << endl;
	G4cout << "ylocal : " << ylocal << endl;
	G4cout << "zlocal : " << zlocal << endl;
	G4cout << "xindex : " << xindex << endl;
	G4cout << "yindex : " << yindex << endl;
	G4cout << "zindex : " << zindex << endl;
	G4cout << "xdindex : " << xdindex << endl;
	G4cout << "ydindex : " << ydindex << endl;
	G4cout << "zdindex : " << zdindex << endl;
